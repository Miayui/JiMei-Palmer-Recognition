    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for batch_data in data_loader.load_data(data_set=phase):
                ...
                input1, input2, labels = data.dataloader.get_two_input_data(rawinputs, rawlabels, data_loader.batch_size)
...
if __name__ == '__main__':
    ...
    _batchsize = 50
    data_loader = data.data_loader.DataLoader_v2(data_dir='Data/TrainingSet/NIR/', image_size=[224, 224],
